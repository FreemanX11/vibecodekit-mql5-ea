...
| `verify.lint_best_practice` | `vibecodekit_mql5.lint_best_practice.BEST_PRACTICE_DETECTORS` | 15 WARN-tier AP detectors (AP-2/4/6/7/8/9/10/11/12/13/14/16/19/22/23). |
